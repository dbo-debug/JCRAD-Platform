              ...
              <div className="rounded-[24px] border border-[#dbe8ef] bg-[#fbfdfe] p-4 shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  {secondaryActionLabel && secondaryActionHref ? (
                    <Link href={secondaryActionHref(selectedStop.customer.id)} className="rounded-full border border-[#cfdde6] bg-white px-4 py-2 text-sm font-semibold text-[#24404d] transition hover:border-[#14b8a6] hover:text-[#0f766e]">
                      {secondaryActionLabel}
                    </Link>
                  ) : null}
                </div>
      ...
      <div className="relative aspect-[1.7/1] min-h-[520px]">
        {args.svgPath ? (
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="pointer-events-none absolute inset-0 h-full w-full">
            <path d={args.svgPath} fill="none" stroke={args.plannedRoute.polyline ? "#173543" : "#14b8a6"} strokeWidth={args.plannedRoute.polyline ? 1.2 : 0.9} strokeDasharray={args.plannedRoute.polyline ? undefined : "2.5 2.5"} strokeLinecap="round" strokeLinejoin="round" opacity={0.9} />
          </svg>
        ) : null}
